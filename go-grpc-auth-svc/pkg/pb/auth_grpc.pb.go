...
type AuthServiceClient interface {
	Register(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*RegisterReponse, error)
...
func (c *authServiceClient) Register(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*RegisterReponse, error) {
	out := new(RegisterReponse)
...
type AuthServiceServer interface {
	Register(context.Context, *RegisterRequest) (*RegisterReponse, error)
...
func (UnimplementedAuthServiceServer) Register(context.Context, *RegisterRequest) (*RegisterReponse, error) {
