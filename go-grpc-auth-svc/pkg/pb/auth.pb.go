...
func (x *RegisterReponse) GetStatus() int64 {
	if x != nil {
		return x.Status
	}
	return 0
...
func (x *RegisterReponse) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
var file_pkg_pb_auth_proto_rawDesc = []byte{
	...
	0x0a, 0x0f, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x52, 0x65, 0x70, 0x6f, 0x6e, 0x73,
	...
	0x03, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x32, 0xba, 0x01, 0x0a, 0x0b, 0x41, 0x75,
	0x74, 0x68, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x3a, 0x0a, 0x08, 0x52, 0x65, 0x67,
	...
	0x75, 0x74, 0x68, 0x2e, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x52, 0x65, 0x70, 0x6f,
...
var file_pkg_pb_auth_proto_goTypes = []interface{}{
	...
	(*RegisterReponse)(nil),  // 1: auth.RegisterReponse
...
var file_pkg_pb_auth_proto_depIdxs = []int32{
	...
	1, // 3: auth.AuthService.Register:output_type -> auth.RegisterReponse
